...
int main()
{
    ...
    WRAP_FUNC("Rq_encode_neon: " CYCLE_TYPE "\n",
            cycles, time0, time1,
            Rq_encode_neon(pk,h));

    WRAP_FUNC("Rq_decode_neon: " CYCLE_TYPE "\n",
            cycles, time0, time1,
            Rq_decode_neon(h,pk));

    WRAP_FUNC("Rounded_encode_neon: " CYCLE_TYPE "\n",
            cycles, time0, time1,
            Rounded_encode_neon(ct,c));

    WRAP_FUNC("Rounded_decode_neon: " CYCLE_TYPE "\n",
            cycles, time0, time1,
            Rounded_decode_neon(c,ct));
